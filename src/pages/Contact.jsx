        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
            <div>
              ...
              <Link to='mailto:angirasoft@gmail.com' className="mt-2 text-sm text-blue-500 dark:text-blue-400">angirasoft@gmail.com</Link>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+91 00000 00000</p>
            </div>
          </div>
