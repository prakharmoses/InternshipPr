    ...
    return (
        <aside>
            ...
            {chatOpen && (<div style={{boxShadow: '0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05)'}}
                className="fixed bottom-[calc(4rem+1.5rem)] right-0 mr-4 bg-white p-6 rounded-lg border border-[#e5e7eb] w-[30vw] h-[70vh]">

                {/* <!-- Heading --> */}
                <div className="flex flex-col space-y-1.5 pb-6">
                    <h2 className="font-semibold text-lg tracking-tight text-slate-800 dark:text-slate-500">Chatbot</h2>
                    <p className="text-sm text-[#6b7280] leading-3">Angirasoft</p>
                </div>
