        ...
        <div className={`fixed top-0 left-0 h-full w-72 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transform ${sidebarActive ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out z-50`}>
            ...
            <div className="p-4">
                <div className="text-center mb-8">
                    <img src="images/pic-1.jpg" className="h-24 w-24 rounded-full mx-auto" alt="Profile" />
                ...
                <nav className="flex flex-col">
                    <Link to="home.html" className="flex items-center p-4 transition-colors duration-300 group text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700">
                        <FaHome className="mr-4 text-xl" />
                        <span className='transition-transform duration-300 group-hover:translate-x-4'>Home</span>
                    </Link>
                    <Link to="about.html" className="flex items-center p-4 transition-colors duration-300 group text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700">
                        <FaQuestion className="mr-4 text-xl" />
                        <span className='transition-transform duration-300 group-hover:translate-x-4'>About</span>
                    </Link>
                    <Link to="courses.html" className="flex items-center p-4 transition-colors duration-300 group text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <Link to="teachers.html" className="flex items-center p-4 transition-colors duration-300 group text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <Link to="contact.html" className="flex items-center p-4 transition-colors duration-300 group text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700">
